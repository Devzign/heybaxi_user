                            ...
                            child: Column(children: [
                              SizedBox(width: Dimensions.iconSizeLarge,
                                child: Image.asset(Images.currentLocation,
                                  color: Theme.of(context).colorScheme.onSecondary.withValues(alpha:.75),
                                ),
                              ),
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  Theme.of(context).primaryColorDark.withValues(alpha:.25),
                                ...
                                child: Row(children: [
                                  ...
                                  InkWell(
                                    ...
                                    child: Icon(Icons.place_outlined, color: Colors.white.withValues(alpha:0.7)),
                                  ),
                                ...
                                Container(height: 50,
                                  ...
                                  child: Row(children: [
                                    ...
                                    InkWell(
                                      ...
                                      child: Icon(Icons.clear, color: Colors.white.withValues(alpha:0.7)),
                                    ),
                                ...
                                InkWell(
                                  ...
                                  child: Container(height: 40,width: 40,
                                    decoration: BoxDecoration(
                                      color: Get.isDarkMode ?
                                      Theme.of(context).cardColor :
                                      Theme.of(context).primaryColorDark.withValues(alpha:.35),
