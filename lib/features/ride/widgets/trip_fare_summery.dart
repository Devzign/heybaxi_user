        ...
        return GetBuilder<PaymentController>(builder: (paymentController) {
          ...
          return Container(
            decoration: BoxDecoration(
              ...
              color: fromPayment ? null : Theme.of(context).primaryColor.withValues(alpha:0.15),
            ),
                        ...
                        child: DropdownButton<String>(
                          ...
                          items: paymentController.paymentTypeList.map((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Text(value.tr,
                                style: textRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha:0.8) : null),
