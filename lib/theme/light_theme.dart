...
ThemeData lightTheme = ThemeData(
  ...
  colorScheme: const ColorScheme.light(
      primary: Color(0xFFce4b2f),
      //  secondary: Color(0xFFce4b2f),
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFFce4b2f))),
);
